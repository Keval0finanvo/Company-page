...
<head>
    ...
    <title>Find Companies by state</title>
<style></style>
</head>
<?php include 'nav.php';?>
    ...
    <div class="row" id='row'>
        <div class="col-12" id='main-col'>
            <div class="grid-container">
                ...
                include 'config.php';
                $selectedButtonValue = '';
                $query = "SELECT DISTINCT state FROM cin";
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    if (isset($_POST["submittedButton"])) {
                        ...
                        $sql = "SELECT cin, COMPANY_NAME, REGISTERED_OFFICE_ADDRESS FROM technowire_data.CIN WHERE state = '$selectedButtonValue'";
                    } else {
                        $sql = "SELECT cin, COMPANY_NAME, REGISTERED_OFFICE_ADDRESS FROM technowire_data.CIN WHERE state IS NOT NULL";
                    }
                } else {
                    $sql = "SELECT cin, COMPANY_NAME, REGISTERED_OFFICE_ADDRESS FROM technowire_data.CIN WHERE state IS NOT NULL";
                }
