...
<head>
    ...
    <title>Find Companies by City</title>
<style></style>
</head>
<?php include 'nav.php';?>
            ...
            <div class="grid-container">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    if (isset($_POST["submittedButton"])) {
                        ...
                        $sql = "SELECT cin, COMPANY_NAME, REGISTERED_OFFICE_ADDRESS FROM technowire_data.CIN WHERE city = '$selectedButtonValue'";
                    } else {
                        $sql = "SELECT cin, COMPANY_NAME, REGISTERED_OFFICE_ADDRESS FROM technowire_data.CIN WHERE city IS NOT NULL";
                    }
                } else {
                    $sql = "SELECT cin, COMPANY_NAME, REGISTERED_OFFICE_ADDRESS FROM technowire_data.CIN WHERE city IS NOT NULL";
                }
